...
object MovieRecommendationsALS {
  ...
  def main(args: Array[String]) {
    ...
    // ask on the command line the UserID you want to show
    // when you create the Run configuration for this scala object Put on the Argument tab the UserID you want. 
    // In our case we choice the ID = 0 
