object LearningScala1 {
  ...
  val hello: String = "Nice!"                     //> hello  : String = Nice!
  println(hello)                                  //> Nice!
  ...
  var helloThere: String = hello                  //> helloThere  : String = Nice!
  helloThere = hello + " There!"
  println(helloThere)                             //> Nice! There!
  ...
  val immutableHelloThere = hello + "There!"      //> immutableHelloThere  : String = Nice!There!
  println(immutableHelloThere)                    //> Nice!There!
  ...
  // for float number dont forget to put the f at the end of the number!
  ...
  println(f"The value for Double Pi is $doublepi%.3f")
                                                  //> The value for Double Pi is 6,283
